...
export default class MapEditorProvider implements vscode.CustomEditorProvider<CelesteMapDocument> {
	...
	private static readonly _onDidChangeActiveDocument = new vscode.EventEmitter<
		CelesteMapDocument | undefined
	>();
	/**
	 * Fired when the active document changes.
	 */
	public static readonly onDidChangeActiveDocument =
		MapEditorProvider._onDidChangeActiveDocument.event;

	public static activeWebview: vscode.WebviewPanel | undefined;
	private static readonly _onDidChangeActiveWebview = new vscode.EventEmitter<
		vscode.WebviewPanel | undefined
	>();
	public static readonly onDidChangeActiveWebview =
		MapEditorProvider._onDidChangeActiveWebview.event;
	...
	private readonly _onDidChangeCustomDocument = new vscode.EventEmitter<
		vscode.CustomDocumentEditEvent<CelesteMapDocument>
	>();
